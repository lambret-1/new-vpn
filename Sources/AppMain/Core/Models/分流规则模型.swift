...
struct 预设规则集: Identifiable, Codable, Hashable {
    ...
    static let 局域网直连: 预设规则集 = {
        let 规则 = [
            分流规则模型(名称: "本地回环", 类型: .IP段, 匹配值: "127.0.0.0/8", 动作: .直连, 优先级: 1, 备注: "本地回环地址"),
            分流规则模型(名称: "私有网络A", 类型: .IP段, 匹配值: "10.0.0.0/8", 动作: .直连, 优先级: 2, 备注: "私有网络A类"),
            分流规则模型(名称: "私有网络B", 类型: .IP段, 匹配值: "172.16.0.0/12", 动作: .直连, 优先级: 3, 备注: "私有网络B类"),
            分流规则模型(名称: "私有网络C", 类型: .IP段, 匹配值: "192.168.0.0/16", 动作: .直连, 优先级: 4, 备注: "私有网络C类"),
            分流规则模型(名称: "链路本地", 类型: .IP段, 匹配值: "169.254.0.0/16", 动作: .直连, 优先级: 5, 备注: "链路本地地址"),
            分流规则模型(名称: "组播地址", 类型: .IP段, 匹配值: "224.0.0.0/4", 动作: .直连, 优先级: 6, 备注: "组播地址"),
            分流规则模型(名称: "广播地址", 类型: .IP段, 匹配值: "255.255.255.255/32", 动作: .直连, 优先级: 7, 备注: "广播地址"),
            分流规则模型(名称: "本地主机名", 类型: .域名精确, 匹配值: "localhost", 动作: .直连, 优先级: 8, 备注: "本地主机名")
        ]
